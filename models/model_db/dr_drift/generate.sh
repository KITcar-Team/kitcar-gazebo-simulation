...
OUT_CAM_YAML=$KITCAR_REPO_PATH/kitcar-gazebo-simulation/src/gazebo_simulation/param/car_specs/dr_drift/camera.yaml
OUT_DEPTH_CAM_YAML=$KITCAR_REPO_PATH/kitcar-gazebo-simulation/src/gazebo_simulation/param/car_specs/dr_drift/depth_camera.yaml
