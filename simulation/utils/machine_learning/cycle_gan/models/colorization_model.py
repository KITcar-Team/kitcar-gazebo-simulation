...
class ColorizationModel(Pix2PixModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        By default, we use 'colorization' dataset for this model. See the original pix2pix paper (
        https://arxiv.org/pdf/1611.07004.pdf) and colorization results (Figure 9 in the paper)
        """
