...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="TANH",
            help="chooses which activation to use. [TANH | HARDTANH | SELU | CELU | SOFTSHRINK | "
            "SOFTSIGN]",
        )
        parser.add_argument(
            "--input_nc",
        ...
        parser.add_argument(
            "--ngf", type=int, default=32, help="# of gen filters in the last conv layer"
        )
        parser.add_argument(
            "--ndf",
            type=int,
