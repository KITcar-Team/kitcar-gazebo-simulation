...
import speaker.speakers.test.test_speaker as speaker
import speaker.speakers.test.test_event_speaker as event
import speaker.speakers.test.test_area_speaker as area
import speaker.speakers.test.test_speed_speaker as speed
import speaker.speakers.test.test_zone_speaker as zone
