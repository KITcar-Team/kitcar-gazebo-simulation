...
ROAD_GENERATION_PATH=$KITCAR_REPO_PATH/kitcar-gazebo-simulation/simulation/utils #Path to road-generation folder
#Read input flags
FLAGS=""
...
ROAD_FOLDER=$KITCAR_REPO_PATH/kitcar-gazebo-simulation/simulation/models/env_db/$ROAD_NAME # Complete path of the road folder
